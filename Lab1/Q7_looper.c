...
task main()
{
	...
	// Move forward at half power for 1.5 seconds
	setMotorSpeed(leftMotor, 37.5);	//Set the leftMotor (motor1) to half power forward (50)
	setMotorSpeed(rightMotor , 28); 	//Set the rightMotor (motor2) to half power forward (50)
	sleep(16500);			//Wait for 1.5 seconds before continuing on in the program.
